            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-12">
                        ...
                        <p className="p-heading">Mobile app offer all the features you need to customize your interior</p>
                    </div> 
                </div>   
                <div className="row">
                        ...
                        <div className="accordion" id="accordionExample">
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">Place furniture, Appliances etc. from an large collection</div>
                                </div>
                            </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">Tryout vast collection of wallpapers or tiles</div>
                                </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">Save your designs and share with others</div>
                                </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">Purchase products directly from the app</div>
                                </div>
                            </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body"> Change tiles on your floors</div>
                                </div>
                            </div>
                    ...
                    <div className="col-xl-7">
                        <div className="image-container">
                            <img className="img-fluid"  src="assets/images/features-dashboard.gif" alt="alternative"/>
                        </div> 
                    </div> 
