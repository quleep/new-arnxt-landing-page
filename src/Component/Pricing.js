        ...
        <div className="row text-center">
          ...
          <div className="row">
                    <div className="col-xl-12">
                        <h1 className="h2-heading"> <underline>Plans and pricing</underline> </h1>
                        <br/>
                        <br/>
                        <h1 className="p-heading">Billing Cycle :</h1>
                         <br/>
                         <br/>
                        <a className="btn-solid-lg" href="#contact">Annual</a>
                            <a className="btn-solid-lg" href="/pricing">Monthly</a>
